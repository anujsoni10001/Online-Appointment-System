	            ...
	            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
	    				...
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					Appointment Id:<input type="text" class="form-control" placeholder=<%=apt_id%>>
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					Amount(RM):<input type="text" class="form-control" placeholder=<%=chargesRM%>>
		    				</div>
	    				</div>
	    				<form action="pay.jsp" class="appointment-form ftco-animate">
                      ...
                      Card Type:<select name="card_type" id="" class="form-control">
                      	<option>Rupay</option>
	    				...
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					Card Number:<input type="text" class="form-control" name="card_number">
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					Expiry Date:<input type="text" class="form-control" name="expiry_date">
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					CVV2/CVC2:<input type="text" class="form-control" name="cvv">
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
	    			 <div class="form-group ml-md-4">
		              <input type="submit" value="Pay" class="btn btn-secondary py-3 px-4">
		            </div>
	    				</div>
	    			</form>
    			</div>
