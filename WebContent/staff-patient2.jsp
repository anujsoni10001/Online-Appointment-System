      ...
      <div class="container">
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <form action="updatestaffpatient.jsp" class="appointment-form ftco-animate">
	          <input type="hidden" name="a_id" value=<%=a_id%>>
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    				   First Name : <input type="text" class="form-control" name="fname" placeholder=<%=fname%>>
		    				</div>
		    				<div class="form-group ml-md-4">
		    					Last Name : <input type="text" class="form-control" name="lname" placeholder=<%=lname%>>
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    				   Telephone :<input type="text" class="form-control" name="telephone" placeholder=<%=telephone%>>
		    				</div>
		    				<div class="form-group ml-md-4">
