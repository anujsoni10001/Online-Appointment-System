...
String a="_";
StringTokenizer h=new StringTokenizer(p.getAddress());
	    		...
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
			    		<div class="col-md-4 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Address: <%=p.getAddress()%></span>
					    </div>
      ...
      <div class="container">
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <form action="update.jsp" class="appointment-form ftco-animate">
	    				<div class="d-md-flex">
		    				<div class="form-group">
		    					First Name :<input type="text" class="form-control"  name="fname" placeholder=<%=p.getFirstName()%>>
		    				</div>
		    				<div class="form-group ml-md-4">
		    					Last Name :<input type="text" class="form-control"  name="lname" placeholder=<%=p.getLastName()%>>
		    				</div>
	    				</div>
	    					<div class="d-md-flex">
		    				<div class="form-group">
		    					Telephone :<input type="text" class="form-control" name="telephone" placeholder=<%=p.getTelephone()%> >
		    				</div>
		    				<div class="form-group ml-md-4">
		    					Address :<input type="text" class="form-control" name="address" placeholder=<%=a%>>
		    				</div>
	    				</div>
	    				<div class="d-md-flex">
		            <div class="form-group ml-md-4">
