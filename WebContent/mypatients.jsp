	    		...
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Email: <%=d_email%></span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">My-Patients-Bookings</h1>
...
java.util.ArrayList<pp.Appointment> a=rd1.ShowAppointDoctor(d_email);
...
<td><%=v.getTime()%></td>
<td><%=v.getStatus()%></td>
<td><a href="completedByDoctor.jsp?a_id=<%=v.getAppointmentId()%>">Set-Completed</a></td>
