      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Add-Doctors</h1>
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <form action="registerdoctor1.jsp" class="appointment-form ftco-animate">
	                    	<div class="d-md-flex">
	    					<div class="form-group">
		    					<div class="form-field">
          					<div class="select-wrap">
                      <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                      Hospital Name:<select name="hname" id="" class="form-control">
                      <%
                    ...
                    {
                     %>
                   <option value=<%=a.getHospitalId()%> ><%=a.getHospitalName()%></option>
                    <%
                     }	
                      %>
                      </select>
	                    ...
	                    <div class="d-md-flex">
		    				...
		    				<div class="form-group ml-md-4">
	    				      ...
	    				      <div class="d-md-flex">
		    				<div class="form-group">
		    					<input type="text" class="form-control" placeholder="NRIC" name="nric">
		    				</div>
		    				<div class="form-group ml-md-4">
	    				   ...
	    				   <div class="d-md-flex">
		    				<div class="form-group">
		    					<input type="password" class="form-control" placeholder="First Name" name="pwd">
		    				</div>
		    				 <div class="form-group ml-md-4">
