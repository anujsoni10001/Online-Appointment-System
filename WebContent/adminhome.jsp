<% 
String admin_id=(String)session.getAttribute("admin_session");
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	    		...
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Welcome Admin <%=admin_id%></span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="registerstaff2.jsp" class="btn btn-secondary py-2 px-3">Add-Doctors</a><a href="registerstaff2.jsp" class="btn btn-secondary py-2 px-3">Register-New-Staff</a><a href="patientrecord2.jsp" class="btn btn-secondary py-2 px-3">Patient-Record</a><a href="LogOut" class="btn btn-secondary py-2 px-3">Logout</a></p>
