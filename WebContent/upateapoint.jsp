      ...
      <div class="container">
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <form action="updatea.jsp" class="appointment-form ftco-animate" name="vinform">
	    		      <%
                      ...
                      Select DoctorId<select name="t1" class="form-control" onChange="sendInfo()">
                       <%
                      ...
                      <%
	    				...
	    				<div class="d-md-flex">
	    			  <div class="form-group ml-md-4">
		              <input type="submit" value="UpdateAppointment" class="btn btn-secondary py-3 px-4">
		            </div>
	    				</div>
	    			</form>
    			</div>
