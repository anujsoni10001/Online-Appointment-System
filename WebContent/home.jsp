    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-lg-2 pr-4 align-items-center">
		    		<a class="navbar-brand" href="index.html">Appointment<span>System</span></a>
	    		</div>
			  ...
			  <div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Email:<%=pemail%></span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="appointment.jsp" class="btn btn-secondary py-2 px-3">Make An Appointment</a><a href="login2.jsp" class="btn btn-secondary py-2 px-3">My Appointment</a><a href="myaccont.jsp" class="btn btn-secondary py-2 px-3">My Account</a><a href="LogOut" class="btn btn-secondary py-2 px-3">Logout</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="index.html" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item"><a href="about.html" class="nav-link">About</a></li>
	        	<li class="nav-item"><a href="doctor.html" class="nav-link">Doctor Records</a></li>
	        	<li class="nav-item"><a href="department.html" class="nav-link">Rating</a></li>
